...
function install-grub() {
	...
	debug-output "installing grub to ${DISKPART1} ..."
	...
	gfxterm_background gzio halt help hfsplus iso9660 jpeg keystatus 
	...
	search_fs_file search_label sleep smbios squash4 test true video 
	...
	gcry_tiger gcry_twofish gcry_whirlpool luks lvm mdraid09 mdraid1x 
